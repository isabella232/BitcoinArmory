...
class DlgLockboxEditor(ArmoryDialog):
   ...
   def doContinue(self):
      ...
      if not USE_TESTNET and isMofNNonStandardToSpend(currM, currN) and not USE_SEGNET:
      ...
      if len(selectedIndexes)>0:
         ...
         if action == actionCopyAddr:
            ...
            if not self.main.getSettingOrSetDefault('DNAA_P2SHCompatWarn', False):
               oldStartChar = "'m' or 'n'" if USE_TESTNET or USE_SEGNET else "'1'"
               newStartChar = "'2'"        if USE_TESTNET or USE_SEGNET else "'3'"
